...
import { MdOutlineLocationOn, MdWork, MdLocationPin, MdOutlineWorkOutline } from 'react-icons/md';
    ...
    <>
        <div className="flex justify-between items-center">
            <div className="flex gap-5">
                <div className="relative border w-40 h-28">
                    <Image src={'/stemuli.png'} alt="Stemuli Logo" fill />
                </div>
        ...
        <div className="mt-12 grid gap-20 grid-cols-3 text-black/80">
            <div className="col-span-2">
                ...
                <Paragraph className='pl-5 text-black/80'>
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&apos;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                </Paragraph>
                <Title level={5} className="mt-10" >
                    Key Responsibilities
                </Title>
                <Paragraph className='mt-3 pl-5 text-black/80'>
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&apos;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                </Paragraph>
                <Title level={5} className="mt-10" >
                    Desired skills
                </Title>
                <ul className="mt-3 pl-5 list-disc text-black/80">
                    <li className="">
            ...
            <div className="">
                ...
                <ul className="mt-5 divide-y border-y">
                    <li className="flex gap-5 items-center py-1">
                        <div className="text-primary"><BsCalendar2Date className='text-2xl' /></div>
                        <div className="">
                    ...
                    <li className="flex gap-5 items-center py-1">
                        <div className="text-primary"><CiBadgeDollar className='text-2xl' /></div>
                        <div className="">
                    ...
                    <li className="flex gap-5 items-center py-1">
                        <div className="text-primary"><MdOutlineWorkOutline className='text-2xl' /></div>
                        <div className="">
...
const DetailsModal = ({ isOpen, onCancel }:{ isOpen:boolean, onCancel?: () => void }) => {
    ...
    return (
        <Modal 
            ...
            width={'80vw'}
            onCancel={onCancel}
            closeIcon={<IoCloseCircleOutline className='text-2xl' />}
            className="z-[10000]">
