    ...
    return (
        <Modal 
            ...
            <div className="md:p-10 z-[10000]">
                <div className="md:flex justify-between items-center">
                    <div className="md:flex gap-5">
                        ...
                        <div className="text-black/80">
                            <Title className='mt-5 md:mt-0 text-2xl 2xl:text-[32px] text-black/80 mb-1'>{ data?.title }</Title>
                            <h3 className="text-md md:text-lg 2xl:text-2xl leading-6 font-medium mb-0">{ data?.companyName }</h3>
                            <div className="mt-2">
                ...
                <Button type='primary' size='large' onClick={onCancel} className="ml-5 md:ml-auto w-full md:w-20 md:absolute bottom-2 md:bottom-auto right-5 text-bold"> OK</Button>
            </div>
        </Modal>
    )
}
